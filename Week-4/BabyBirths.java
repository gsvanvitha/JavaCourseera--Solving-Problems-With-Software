...
public double getAverageRank(String name, String gender){
    ...
    public static void main(String[] args){
        ...
        System.out.println(babyBirths.getRank(2014, "Emma", "F"));
        babyBirths.whatIsNameInYear("Isabella", 2012, 2014, "F");
        //System.out.println(babyBirths.yearOfHighestRank("Olivia","F"));
        //System.out.println(babyBirths.getAverageRank("Isabella","F"));
        System.out.println(babyBirths.getTotalBirthsRankedHigher(2012, "Ethan", "M"));
    }
}
